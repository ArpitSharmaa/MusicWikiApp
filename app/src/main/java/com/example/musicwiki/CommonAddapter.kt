...
class CommonAddapter(val context: Context,val listof:List<track>,val listner:(track: track)->Unit):RecyclerView.Adapter<CommonAddapter.Viewholder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Viewholder {
      val layoutitem = LayoutInflater.from(parent.context).inflate(R.layout.imagelist,parent,false)
